...
Start-DataImportLogFileLogger -FilePath "C:\_temp\logs\import-suits_$timestamp.csv"
...
Import-DataImportSuitsDatData -Path "C:\_projects\att.dataimport\src\dev\suits.txt"
